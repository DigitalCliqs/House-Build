...
export const ARCHITECTURE_SPEC={
 metadata:{projectId:'anamarija-euromax',version:'1.4.0',status:'working-design',units:'m',sourceBasis:'Domprojekt Anamarija original programme expanded to working ~200 m² accessible design.',note:'Envelope plus internal wall gaps are explicitly classified. Door coordinates remain provisional pending architect drawings.'},
 ...
 roof:{style:'articulated-multi-pitched',eaveHeight:3.38,overhang:.55,volumes:[{id:'west-wing',x:-6.3,z:HOUSE.z,width:8.4,depth:HOUSE.depth,ridgeHeight:5.35,ridgeAxis:'z'},{id:'central-entry',x:-1.2,z:4.4,width:3.0,depth:7.0,ridgeHeight:4.72,ridgeAxis:'z'},{id:'living-wing',x:5.15,z:HOUSE.z,width:10.7,depth:HOUSE.depth,ridgeHeight:5.60,ridgeAxis:'z'},{id:'terrace-canopy',x:4.7,z:ZN-1.75,width:11.6,depth:3.5,ridgeHeight:4.35,ridgeAxis:'x'}]},
